  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="flex gap-4 p-4">
        ...
        {/* Right Sidebar - Wider and Better Spacing */}
        <div className="w-96 flex-shrink-0 space-y-4">
          {/* Financial News Panel */}
          <div className="h-[calc(50vh-1rem)] bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-md border border-white/10 rounded-2xl p-4 shadow-2xl">
            <EnhancedNewsPanel stockSymbol={selectedStock.symbol} />
          </div>
          
          {/* Live Market AI Panel */}
          <div className="h-[calc(50vh-1rem)] bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-md border border-white/10 rounded-2xl p-4 shadow-2xl">
            <ChatPanel />
          </div>
        </div>
